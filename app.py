...
page_1_layout = html.Div([navbar, 
                 dbc.Container([
                    ...
                    html.P("""
                     ...
                     html.P(["Number of deaths per country last updated per: ", yesterday], style = {"fontSize":"70%"}),
                     html.P(["Forecast fitted to hospitalizations in NL up until: ", forecast_day], style = {"fontSize":"70%"})],
